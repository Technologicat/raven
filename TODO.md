...
- **RAG access via tool-call** (see the Tools section). The largest item, the only one that is new
  ...
  one turn in three (Q11 in `briefs/reference/context-inject-shape-measurements.md`). Carries two attached
