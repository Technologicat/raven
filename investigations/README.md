...
| `follow-tail-drift/` | Why the chat view intermittently stops following a streaming reply. Diagnosed from an ordinary run's log rather than reproduced — the refusal reports its own numbers |
