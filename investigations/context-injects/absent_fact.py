...
**That rejection is model-specific, and 27B is no longer the model to measure against.** On qwen3.6-35b-a3b
the runaway belongs to the *as-shipped* wording instead — three of four samples at T=0 — while
