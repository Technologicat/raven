    ...
    def render_frame(self) -> None:
        ...
        with self._lock:
            ...
            for animation in snapshot:
                ...
                #
                # Which is why it is not the only guard. This one can only fire on a leak that *faults*,
                # and a leaked animation faults only if it happens to touch a deleted widget — so one
