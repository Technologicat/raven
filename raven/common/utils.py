...
#
# Rendering a parsed author name for display, which is a citation-formatting job rather than a BibTeX one
# — the input is `bibtexparser`'s `NameParts`, and the output goes into a label. Reading and repairing
# BibTeX lives in `raven.papers.bibtex`.
