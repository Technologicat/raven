...
_DEFAULT_FLAGS = {  # Whether a thinking model may reason before it answers. On by default, which is the
                  ...
                  # What the chat search looks in, besides message text. Thinking traces are left out by
                  # default, since most of the time a reader is after the conversation proper; tool results are in.
                  "search_thinking": False,
                  "search_tools": True}
