...
def format_provenance_manifest(payloads: List[Dict[str, Any]],
                               exported_at: Optional[str] = None) -> str:
    """Return a YAML front-matter block recording where the messages in `payloads` came from.
    ...
    side of the boundary can do is attach the provenance it does know, which is what this is.
