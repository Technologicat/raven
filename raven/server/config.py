...
animator_defaults = {
    ...
    "upscale_quality": "bicubic",  # only used if upscale != 1.0; quality "low": anime4k fast, acceptable image quality; "high": anime4k slow, good image quality; "bilinear": lightning-fast, bad quality; "bicubic": very fast, often acceptable quality; "lanczos": fast, sharper than bicubic.
