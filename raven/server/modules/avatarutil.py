...
supported_cels = [
    ...
    "data1", "data2", "data3", "data4",   # scifi "data eyes"; optional, up to 4 cels. Controlled only programmatically, via `raven.client.api.avatar_start_data_eyes` / `avatar_stop_data_eyes`.
