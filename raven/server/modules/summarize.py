...
def init_module(model_name: str,
    ...
    global summarizer
    global nlp_pipe
    print(f"Initializing {Fore.GREEN}{Style.BRIGHT}summarize{Style.RESET_ALL} on device '{Fore.GREEN}{Style.BRIGHT}{device_string}{Style.RESET_ALL}' with summarization model '{Fore.GREEN}{Style.BRIGHT}{model_name}{Style.RESET_ALL}' and spaCy model '{Fore.GREEN}{Style.BRIGHT}{spacy_model_name}{Style.RESET_ALL}' on device '{Fore.GREEN}{Style.BRIGHT}{spacy_device_string}{Style.RESET_ALL}'...")
    try:
